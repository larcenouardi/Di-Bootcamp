...
// function to display the list of robots
function displayRobots(filteredRobots) {
  const html = filteredRobots.map(robot => `
...
// Listen to the input keyup to filter robots
searchBox.addEventListener('keyup', filterRobots);
